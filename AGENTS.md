...
- Adaptive fallback learning is shadow-first. Promotion is allowed only from sanitized aggregate outcomes after configured sample/confidence thresholds; deterministic rules remain the fallback when confidence is low.
