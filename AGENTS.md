...
- The Plex Transcoder shim should prefer a precomputed version index when available, then fall back to bounded Plex search/section scans, so first-segment decisions stay fast.
